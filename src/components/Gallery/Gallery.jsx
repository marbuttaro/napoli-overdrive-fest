...
const PHOTOS = [
  { src: g1, alt: 'Show acrobatico su moto elettrica al festival', col: '2 / 3', row: '2 / 3' },
  { src: g5, alt: 'Supercar esposte al Centro Direzionale', col: '3 / 5', row: '1 / 2' },
  { src: g3, alt: 'Wheelie davanti al Centro Direzionale di Napoli', col: '3 / 4', row: '3 / 5' },
  { src: g6, alt: 'Moto da corsa Ducati in esposizione', col: '1 / 2', row: '3 / 4' },
  { src: g4, alt: 'Pilota davanti al palco del festival', col: '2 / 3', row: '5 / 6' },
  { src: g2, alt: 'Piloti in azione tra il pubblico', col: '4 / 5', row: '5 / 6' },
];
